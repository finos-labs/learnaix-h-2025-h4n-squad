$functions['block_ai_chat_call_snowflake_llm'] = [
    'classname'   => 'block_ai_chat\\external\\CallSnowflakeLlm',
    'methodname'  => 'execute',
    'description' => 'Call Snowflake Cortex LLM and return the response.',
    'type'        => 'write',
    'ajax'        => true,
